...
//    NSLog(@"Error - %@",outError);
    ...
    if (chatPlayer == nil) {
        ...
        // update Parse. - do it after playback has finished.
//        [self incrementListenCountForIndexPath:indexPath];
...
// TODO: this shouldn't be necessary if we let Parse order by timestamp.
-(void) arrangeData {
